  ...
  static final Map<Locale, AppLocalizations_Labels> languages = {
    ...
    Locale.fromSubtags(languageCode: "de"): AppLocalizations_Labels(
      auth: AppLocalizations_Labels_Auth(
        ...
        forgotPasswordLabelButton: "Passwort vergessen?",
        ...
        signInonForgotPasswordLabelButton: "Einloggen",
      ),
      settings: AppLocalizations_Labels_Settings(
    ...
    Locale.fromSubtags(languageCode: "hi"): AppLocalizations_Labels(
      auth: AppLocalizations_Labels_Auth(
        ...
        forgotPasswordLabelButton: "पासवर्ड भूल गए?",
        ...
        signInonForgotPasswordLabelButton: "साइन इन करें",
      ),
      settings: AppLocalizations_Labels_Settings(
        title: "समायोजन",
    ...
    Locale.fromSubtags(languageCode: "pt"): AppLocalizations_Labels(
      auth: AppLocalizations_Labels_Auth(
        ...
        forgotPasswordLabelButton: "Esqueceu a senha?",
        ...
        signInonForgotPasswordLabelButton: "Assinar em",
      ),
      settings: AppLocalizations_Labels_Settings(
        title: "Configurações",
        language: "Língua",
    ...
    Locale.fromSubtags(languageCode: "zh"): AppLocalizations_Labels(
      auth: AppLocalizations_Labels_Auth(
        ...
        forgotPasswordLabelButton: "忘记密码？",
        signUpLabelButton: "创建一个帐户",
        signUpError: "注册失败。",
        signInLabelButton: "有一个账户？登入。",
        forgotPasswordNotice: "检查你的电子邮件，并按照重置密码的说明。",
        signInonForgotPasswordLabelButton: "登入",
      ),
      settings: AppLocalizations_Labels_Settings(
        title: "设置",
        language: "语言",
    ...
    Locale.fromSubtags(languageCode: "ja"): AppLocalizations_Labels(
      auth: AppLocalizations_Labels_Auth(
        ...
        forgotPasswordLabelButton: "パスワードをお忘れですか？",
        signUpLabelButton: "アカウントを作成する",
        signUpError: "サインアップに失敗しました。",
        signInLabelButton: "アカウントを持っています？サインイン。",
        forgotPasswordNotice: "あなたの電子メールをチェックして、あなたのパスワードをリセットするための指示に従ってください。",
        signInonForgotPasswordLabelButton: "サインイン",
      ),
      settings: AppLocalizations_Labels_Settings(
        title: "設定",
        language: "言語",
